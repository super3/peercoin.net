<?php  $page_title = "Mining Guide"; include ('header.php'); ?>
	...
	<div class="row row-nomargin">
		<div class="col-md-12 text-center">
			<h2>Follow these steps to start mining Peercoin!</h2>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			<ol>
				<li>
					<b>Set up the wallet software</b>
					<br>
					If you haven't yet, download the <a href="wallet">Peercoin wallet</a>.
				</li>
				<li>
					<b>Select a mining pool</b>
					<div class="row">
						<div class="col-md-6">
							<h4 class="nomargin">Peercoin-dedicated pools:</h4>
							<ul>
							    <li>
						...
						<div class="col-md-6">
							<h4 class="nomargin">Multicoin pools:</h4>
							<ul>
      							<li>
