...
$lang['ru'] += array(
	...
	'mintguide.peerunity' => 'Peerunity - программа, разработанная сообществом Peercoin. Она имеет больше функций, чем стандартный клиент Peercoin версии 0.4, а так же более простые методы создания монет. Она доступна для Windows, Linux и OS X. Вы можете скачать её здесь и посмотреть тред запуска <a href="http://www.peercointalk.org/index.php?topic=2902.0">здесь</a>.',
