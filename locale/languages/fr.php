...
$lang['fr'] += array(
	...
	'exchanges.what_are_desc' => 'Des bourses d\'<b>échange</b> vous permettent d\'utiliser votre monnaie gouvernementale telle que le Dollar ou l\'Euro, afin d\'acheter et vendre des peercoins. Ces bourses facilitent aussi les échanges de peercoins avec d\'autres crypto-monnaies, comme les bitcoins.',
	'exchanges.buy_sell' => 'Placer un Ordre',
...
$lang['fr'] += array(
	...
	'index.why_peercoin_desc' => 'Peercoin cherche à être la crypto-monnaie la plus fiable au moindre coût, en récompensant tous les utilisateurs pour renforcer le réseau avec un retour de 1% sur leur investissement.',
	...
	'index.transparent_protocol' => 'Protocole <b>Securitaire</b>',
	'index.transparent_protocol_desc' => 'Protège votre investissement depuis 2012',
	...
	'index.investors_desc' => 'Retour d'investissement de 1&#37; garantie.',
...
$lang['fr'] += array(
	...
	'investors.guaranteed_returns_desc' => 'Après avoir été conservés pendant 30 jours, les peercoins ont la possibilité de gagner une récompense annualisée de 1&#37;. <a href="minting">Cliquez pour en savoir plus au sujet du monnayage</a>. Vous pouvez aussi acheter des Peercoins sur une des nombreuses <a href="exchanges">échanges</a>',

);
$lang['fr'] += array(
	//Merchants
	'merchants.instant' => 'Soyez payé immédiatement',
	'merchants.instant_desc' => 'Les transactions sont traitées presque immédiatement via la technologie de la chaîne de blocs. Un explorateur de blocs vérifie un encaissement de manière instantanée.',
	'merchants.no_chargebacks' => 'Évitez les remboursements',
	'merchants.no_chargebacks_desc' => 'Une fois qu\'un paiement a été confirmé par le réseau, il est sécurisé par de la cryptographie de haut niveau, rendant impossible son annulation par le client.',
...
$lang['fr'] += array(
	...
	'mining.compatible_with_bitcoin_desc' => 'Peercoin utilise le même algorithme d\'extraction que Bitcoin, c\'est à dire SHA-256. N\'importe quel matériel fonctionnant pour le réseau Bitcoin peut aussi être utilisé pour extraire des peercoins.',
	'mining.fair_distribution' => 'Distribution Juste',
...
$lang['fr'] += array(
	...
	'minting.secure_the_network' => 'Sécuriser le Réseau',
	'minting.secure_the_network_desc' => 'Chaque fois que votre frappe de monnaie génère un bloc, vos pièces protègent le réseau. Pour réaliser une attaque fiable du réseau Peercoin, un utilisateur malveillant doit contrôler la majorité des pièces utilisées dans la frappe de monnaie, ce qui pourrait même finir par nuire à son investissement.',
...
$lang['fr'] += array(
	...
	'newcomers.withdraw_coins_desc' => 'Prenez possession de vos peercoins en les envoyant à une adresse générée par le logiciel portefeuille. Ceci vous protègera dans l\'éventualité où la bourse d\'échange fermerait ses portes avec votre argent dedans.',
