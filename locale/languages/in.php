...
$lang['in'] += array(
	...
	'developers.core_protocol_desc' => 'Edisi berikutnya dari dompet protokol inti, versi 0.5, akan berisi beberapa fitur berikut:',
	'developers.cold_wallet_minting' => 'Pencetak Dompet Dingin',
	'developers.cold_wallet_minting_desc' => 'Saat ini, untuk mencetak koin baru, pengguna harus menyimpan dompet terhubung ke jaringan, yang dikenal sebagai <strong>dompet panas</ strong>. Dompet panas berada pada risiko yang lebih besar terhadap malware mencuri koin mereka, karena mereka harus tetap terhubung ke internet selama proses mencetak. Dalam versi berikutnya dari Peercoin, khusus <strong>pencetakan kunci</ strong> akan memungkinkan pengguna untuk mencetak sambil menjaga tombol pengeluaran mereka sepenuhnya offline.',
	'developers.optional_checkpointing' => 'Opsional Checkpointing',
	'developers.optional_checkpointing_desc' => 'Saat ini, jaringan menggunakan checkpointing terpusat untuk melindungi terhadap serangan. Kebutuhan untuk keamanan ini menurun seiring berkembangnya jaringan, sehingga versi berikutnya akan membuat checkpointing ini opsional. Sebuah versi masa depan akan mematikan checkpointing secara standar.',
	'developers.peercoin_ecosystem' => 'Ekosistem Peercoin',
	'developers.peer4commit' => 'Apakah Anda ingin terlibat dalam pengembangan Peercoin <strong>dan</ strong> dibayar untuk itu? Inilah kesempatan Anda! <a href="http://peer4commit.com/">Peer4commit</a> menyediakan pusat kegiatan untuk pembangunan. Anda dapat:',
...
$lang['in'] += array(
	...
	'exchanges.buy_sell' => 'Menempatkan Pemesanan',
	'exchanges.buy_sell_desc' => 'Transaksi dimulai dengan penempatan membeli dan menjual pesanan. Ciptakan <b>Membeli pesanan</b> untuk meminta sejumlah Peercoin untuk harga tertentu. Buat urutan <b>Jual pemesanan</b> untuk menawarkan penjualan Peercoin. Ketika membeli dan menjual bertemu dengan harga yang sama, perdagangan secara otomatis selesai, dan laporan dari kedua belah pihak dikreditkan dengan uang mereka diperdagangkan. A <b>Pasar Pemesanan</b> akan memperdagangkan segera dengan harga yang saat ini tersedia.',
	'exchanges.fees' => 'Biaya',
	'exchanges.fees_desc' => 'Setiap kali perdagangan terjadi, sebagian kecil diambil oleh pertukaran untuk memfasilitasi transaksi. Hal ini dikenal sebagai <b>Biaya Perdagangan</b>. Beberapa pertukaran juga dikenai biaya <b>Penarikan Biaya</b> ketika Anda menarik uang baru Anda dari pertukaran.',
	'exchanges.choosing' => 'Memilih pertukaran',
	'exchanges.disclaimer' => 'Peringatan: Pastikan untuk menarik Peercoin Anda dari pertukaran setelah Anda membelinya. Menyimpan uang di dompet Anda sendiri lebih aman, dan membuat Anda memenuhi syarat untuk 1&#37;reward pencetak Peercoin ini.',
	'exchanges.location' => 'Lokasi',
	'exchanges.notes' => 'Catatan',
...
$lang['in'] += array(
	...
	'second_ago' => 'Sedetik yang lalu',
	'seconds_ago' => 'Beberapa detik yang lalu',
...
$lang['in'] += array(
	...
	'header.mint_peercoins' => 'Pencetakan Peercoin',
...
$lang['in'] += array(
	...
	'index.why_peercoin_desc' => 'Peercoin berusaha untuk menjadi cryptocoin paling aman dengan biaya terendah, dengan memberikan reward kepada semua pengguna untuk memperkuat jaringan.',
	...
	'index.transparent_protocol' => '<b>Transparansi</b> Protokol',
	'index.transparent_protocol_desc' => 'Jaringan ini sepenuhnya open source.',
	...
	'index.investors_desc' => 'Menghasilkan pencetakan dijamin mendapatkan reward 1&#37; .',
...
$lang['in'] += array(
	...
	'investors.limited_supply' => 'Pasokan Terbatas',
	'investors.limited_supply_desc' => 'Tingkat inflasi tahunan Peercoin rata-rata  telah di bawah 5&#37;  selama tahun 2014, dan terus menurun. Lihat <a href="http://peerchain.net/charts.html">peerchain.net</a> untuk data historis yang lebih rinci.',
	'investors.efficient_security' => 'Keamanan Efisien',
	'investors.efficient_security_desc' => 'Peercoin adalah koin pertama proof-of-stake, yang berarti tidak memerlukan daya menghitung besar untuk mengamankan jaringan. Masuk ke dalam seluk-beluk dengan <a href="whitepaper">Panduan Peercoin</a>.',
	'investors.guaranteed_returns' => 'Pengembalian Dijamin',
...
$lang['in'] += array(
	...
	'merchants.no_chargebacks' => 'Menghindari Chargebacks',
	'merchants.no_chargebacks_desc' => 'Setelah pembayaran telah dikonfirmasi oleh jaringan, dijamin dengan kriptografi kelas dunia, sehingga mustahil bagi pelanggan untuk mundur.',
	'merchants.no_transaction_fees' => 'Memotong biaya transaksi',
...
$lang['in'] += array(
	...
	'mining.fair_distribution' => 'Distribusi yang Adil',
	'mining.fair_distribution_desc' => 'Pertambangan Proof of Work digunakan untuk menyebarkan distribusi koin baru, sementara keamanan jaringan dipertahankan sepenuhnya oleh Pencetakan Proof of Stake. Ini berarti bahwa kerentanan pertambangan Bitcoin seperti Pertambangan yang mementingkan diri sendiri tidak mempengaruhi keamanan Peercoin.',
...
$lang['in'] += array(
	...
	'minting.secure_the_network' => 'Amankan Jaringan',
	'minting.secure_the_network_desc' => 'Setiap kali percetakan Anda menghasilkan blok, koin Anda membantu menjaga jaringan. Untuk dapat menyerang jaringan Peercoin, pengguna berbahaya harus mengontrol mayoritas semua pencetakan koin, yang bahkan bisa berakhir merugikan investasi sendiri.',
	'minting.earn_reward' => 'Mendapatkan Reward',
...
$lang['in'] += array(
	...
	'newcomers.withdraw_coins_desc' => 'Memiliki peercoins Anda dengan mengirimkan mereka ke alamat yang dihasilkan oleh perangkat lunak dompet. Ini akan melindungi Anda dalam hal pertukaran menutup pintu sementara uang Anda di dalam.',
	'newcomers.learn_more' => 'Pelajari Lebih Lanjut',
