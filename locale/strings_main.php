...
$locale_strings['pl']['download_wallet'] = "Pobierz portfel";
...
$locale_strings['pl']['big_welcome_header'] = "Bezpieczna. Zrównoważona. <span><strong>Peercoin</strong> dla Ciebie.</span>";
...
$locale_strings['pl']['big_404'] = "<span><strong>404</strong> Nie znaleziono strony. </span> Użyj górnego menu, by przejść na inną stronę.";
...
$locale_strings['pl']['why_peercoin_header_innovation'] = "<b>Innowacyjny</b> algorytm";
...
$locale_strings['pl']['market_cap'] = "Kapitalizacja";
...
$locale_strings['pl']['total_supply'] = "Całkowity zasób";
...
$locale_strings['pl']['ticker_last_updated'] = "Ostatnia aktualizacja: ";
...
$locale_strings['pl']['ticker_last_updated_never'] = "nigdy";
...
$locale_strings['pl']['why_peercoin_desc_innovation'] = "Ostatnią innowacją Peercoin jest hybrydowy system <a href='/bin/peercoin-paper.pdf'>proof-of-stake/proof-of-work</a>. Tak jak w przypadku innych <a href='https://en.wikipedia.org/wiki/Cryptocurrency'>kryptowalut</a> początkowe monety mogą być wydobywane, ale sieć szkieletowa jest utrzymywana przez posiadaczy monet, a nie przez najszybsze <a href='https://en.bitcoin.it/wiki/Pooled_mining'>kopalnie</a>.";
...
$locale_strings['pl']['why_peercoin_header_security'] = "Zwiększone <b>bezpieczeństwo</b>";
...
$locale_strings['pl']['why_peercoin_desc_security'] = "Utrzymanie sieci z pomocą hybrydowego algorytmu proof-of-work/proof-of-stake redukuje ryzyko <a href='http://www.pcworld.com/article/2060840/selfish-miner-attack-could-devastate-bitcoin-researchers-say.html'> problemu egoistycznego górnika</a>, <a href='https://en.bitcoin.it/wiki/Weaknesses'>ataków 51%</a> oraz pompowania bloków, które były wykorzystywane do nadużyć w przypadku innych walut.";
...
$locale_strings['pl']['why_peercoin_header_efficiency'] = "<b>Oszczędność</b> kosztowa i energetyczna";
...
$locale_strings['pl']['why_peercoin_desc_efficiency'] = "Utrzymanie sieci wymaga o wiele mniej energii niż sprzętowe generowanie skrótów proof-of-work. Proof-of-stake radzi sobie również z problemem <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'>~ $1 miliarda \"podatku\"</a> który ma sieć Bitcoin przez algorytmy proof-of-work.";
...
$locale_strings['pl']['why_peercoin_button'] = "Dlaczego Peercoin?";
...
$locale_strings['pl']['why_peercoin_title'] = "Dlaczego <span>Peercoin</span>?";
...
$locale_strings['pl']['why_peercoin_desc'] = "Peercoin to krytowaluta oraz zdecentralizowana sieć pozwalająca na globalne transakcje peer-to-peer z pośrednictwem internetu. Dzięki innowacyjnemu algorytmowi menniczemu, sieć Peercoin zużywa o wiele mniej energii, zapewnia większe bezpieczeństwo i wynagradza użytkowników w bardziej zrównoważony sposób niż inne kryptowaluty.";
...
$locale_strings['pl']['fund_peercoin'] = "Finansuj <span>Peercoin.</span>";
...
$locale_strings['pl']['fund_peercoin_accepting_donations'] = "Obecnie przyjmujemy dotacje na rozwój Peercoin oraz sieci.";
...
$locale_strings['pl']['fund_peercoin_donations_btc'] = "Dotacje BTC: ";
...
$locale_strings['pl']['fund_peercoin_donations_ppc'] = "Dotacje PPC: ";
...
$locale_strings['pl']['block_explorer'] = "Block Explorer";
...
$locale_strings['pl']['faq_header'] = "Częste <span>pytania</span>";
...
$locale_strings['pl']['faq_q_title_innovation'] = "Chcę wiedzieć więcej o innowacyjnym algorytmie.";
...
$locale_strings['it']['faq_q_desc_innovation'] = "
						<p>L'innovazione originale e degna di nota di Peercoin è il sistema ibrido proof-of-stake/proof-of-work.</p>
						<p>Come altre criptovalute, le monete iniziali possono essere minate attraverso il processo di hashing proof-of-work più comune. Tuttavia a differenza di altre monete, visto che la difficotltà di hash aumenta col tempo, gli utenti continuano a essere ricompensati con monete generate dall'algoritmo supplementare proof-of-stake. Chiunque detenga l'1% della valuta sarà ripagato con l'1% di tutti i blocchi di monete proof-of-stake.</p>
						<p>Oltre a una maggiore protezione e una migliore efficienza energetica, l'algoritmo ibrido proof-of-work/proof-of-stake combatte le tendenze deflazionistiche che le criptovalute possono subire a causa del loro duro tetto di conio.</p>";
$locale_strings['ru']['faq_q_desc_innovation'] = "<p>Оригинальное и инновационное изобретение Peercoin &ndash; это гибридная proof-of-stake/proof-of-work hybrid система.</p>
						<p>Как и в других криптовалютах, изначально монеты могут добываться с помощью обычного proof-of-work майнинга. Но в отличие от других криптовалют, с увеличением сложности по прошествии времени, пользователи продолжают получать монеты через дополнительный алгоритм генерации монет &ndash; proof-of-stake. Пользователь, имеющий 1% всей валюты, будет получать 1% всех proof-of-stake блоков.</p>
						<p>Вдобавок к увеличенной надёжности и энергетической эффективности, гибридный алгоритм proof-of-work/proof-of-stake противостоит дефляции, к которой склонны остальные криптовалюты из-за жёстко ограниченного объёма монет.</p>";
...
$locale_strings['no']['faq_q_desc_innovation'] = "
						<p>Peercoin sin originale og bemerkelsesverdige oppfinnelse er proof-of-stake/proof-of-work hybridsystemet.</p>
						<p>Som andre kryptovalutaer blir de første myntene skapt ved gruvedrift gjennom den vanlige proof-of-work prosessen populært kalt hashing. Men i motsetning til andre kryptovalutaer, ettersom vanskelighetsgraden på hashingen øker over tid, blir brukerene belønnet med mynter generert av den ekstra proof-of-stake algoritmen. Alle som holder 1% av valutaen vil bli kompensert med 1% av alle blokkene produsert ved hjelp av proof-of-stake.</p>
						<p>I tillegg til økt sikkerhet og bedre energieffektivitet, vil proof-of-work/proof-of-stake hybridalgoritmen motvirker den deflatoriske tendensen som kryptovalutaer kan lide av på grunn av deres satte tak på antall mynter.</p>";
$locale_strings['pl']['faq_q_desc_innovation'] = "
						<p>Oryginalną i ciekawą innowacją Peercoin jest algorytm hybrydowy proof-of-stake/proof-of-work.</p>
						<p>Tak jak w przypadku innych kryptowalut, pierwotne monety mogą być wydobywane z pomocą powszechnie stosowanego procesu. Jednakże w przeciwieństwie do innych monet, w miarę jak z czasem rośnie trudność wydobycia, uzytkownicy są wynagradzani monetami generowanymi z pomoca dodatkowegi algorytmu proof-of-stake. Każdy posiadacz 1% waluty będzie wynagrodzony 1% wszystkich bloków monet wytworzonych przez algorytm proof-of-stake.</p>
						<p>Poza zwiększonym bezpieczeństwem i oszczędnością energetyczną, hybrydowy algorytm proof-of-work/proof-of-stake walczy z tendencjami deflacyjnymi, na które podatne są kryptowaluty ze względu na ograniczenia mennicze. </p>";						
...
$locale_strings['pl']['faq_q_title_security'] = "Chcę wiedzieć więcej na temat zwiększonego bezpieczeństwa.";
...
$locale_strings['it']['faq_q_desc_security'] = "
						<p>Generare blocchi attraverso l'algoritmo ibrido proof-of-work/proof-of-stake riduce il rischio della falla del Selfish-Miner di Cornell, di attacchi del \">50%\" e il dilatare i blocchi che sono stati usati per sfruttare altre valute.</p>
						<p>La porzione proof-of-stake dell'algoritmo si trova al centro di questa protezione perché aumenta drasticamente il costo di un attacco. Acquisire il 51% di tutte le monete esistenti richiede più sforzo e risorse dell' acquisire il 51% di ogni potere estrazione. Inoltre, in un attacco \">50%\", l'investimento dell'attaccante sarà, per definizione, a rischio di grave perdita perché l'attaccante sarà in possesso della maggioranza delle monete che stanno attaccando. Questo rischio di perdita riduce in primo luogo la spinta di tentare tale attacco.</p>
						<p>Peercoin impiega anche altre funzionalità di protezione avanzata tra cui applicare spese di transazione a livello di protocollo per difendersi da attacchi che dilatano i blocchi.</p>";
$locale_strings['ru']['faq_q_desc_security'] = "<p>Генерация блоков с помощью гибридного алгоритма proof-of-work/proof-of-stake снижает риск Проблемы Корнелла (Эгоистичный Майнер), атак \">50%\" и раздувания размера блоков, &ndash; проблем, которые использовались для атак на другие криптовалюты.</p>
						<p>Часть алгоритма, реализующая схему proof-of-stake, является сердцем этой системы безопасности, поскольку чрезвычайно увеличивает стоимость таких атак. Чтобы получить 51% всех существующих монет, требуется гораздо больше усилий и ресурсов, чем для получения 51% майнинговой мощности. Кроме того, при атаке посредством получения \">50%\" всех монет, злоумышленник рискует потерять все свои вложения, поскольку сам является главным держателем той валюты, на которую производит атаку. Это лишает смысла такую атаку.</p>
						<p>Peercoin также использует другие продвинутые нововведения, например, заданная самим протоколом комиссия на транзакции, которая защищает сеть от спама транзакциями.</p>";
$locale_strings['zh']['faq_q_desc_security'] = "
						<p>使用权益证明和工作量证明混合算法产生的区块可以避免自私矿工攻击和\">50%\" 攻击,不易于像其他货币一样被不法之徒危害.</p>
...
$locale_strings['no']['faq_q_desc_security'] = "
						<p>Generering av blokker gjennom proof-of-work/proof-of-stake hybridalgoritmen reduserer risikoen for Selfish-Miner Cornell Flaw, \">50%\" angrep og oppblåsingen av blokker som har blitt brukt for å utnytte andre kryptovalutaer.</p>
						<p>Proof-of-stake delen av algoritmen er selve kjernen i sikkerheten siden den drastisk øker kostnaden ved ett angrep. Å få tilgang på 51% av alle eksisterende mynter krever mer innsats og ressurser enn å få tilgang på 51% av all datakraften brukt til gruvedrift. Videre, i et \">50%\" stakeangrep, vil angriperen sin investering i majoriteten av myntene sørge for at han taper investeringen sin hvis han lykkes med angrepet. Denne risikoen for tap reduserer intensivet til å prøve seg på slikt ett angrep i utganspunktet.</p>
						<p>Peercoin har også andre avanserte sikkerhetsmekanismer, slik som håndhevete transaksjonskostnader i protokollen for å forvare seg mot angrep som blåser opp størrelsen på blokker.</p>";
$locale_strings['pl']['faq_q_desc_security'] = "
						<p>Generowanie bloków za pomocą hybrydowego algorytmu proof-of-work/proof-of-stake redukuje ryzyko ataków Selfish-Miner Cornell Flaw, \">50%\" oraz pompowania bloków, które były obserwowan w przypadkach innych kryptowalut.</p>
						<p>Część algorytmu proof-of-stake stanowi serce systemu bezpieczeństwa ponieważ drastycznie podnosi koszt ataku. Pozyskanie 51% wszystkich istniejących monet wymaga zdecydowanie więcej wysiłku i środków niż pozyskanie 51% mocy wydobywczej. Co więcej, w przypadku ataku przy pomocy \">50%\" środków, inwestycja atakującego będzie z definicji narażona na wielkie straty, ponieważ atakujący będzie posiadał większośc monet, które zaatakuje. Takie ryzyko strat redukuje celowość jakiegokolwiek ataku.</p>
						<p>Peercoin uzywa też innych zaawansowanych mechanizmów obronnych w postaci wymuszania opłat za transakcje na poziomie protokołu, by uchronić się przed atakami pompującymi blok.</p>";
...
$locale_strings['pl']['faq_q_title_efficiency'] = "Chcę wiedzieć więcej na temat oszczędności energetycznej i kosztowej";
...
$locale_strings['it']['faq_q_desc_efficiency'] = "
							<p>Generare blocchi tramite proof-of-stake richiede molta meno energia che generare hash proof-of-work intensi per gli hardware. Questo significa che col tempo, la rete Peercoin consumerà meno energia poiché i blocchi proof-of-work diventano meno remunerativi e i blocchi vengono generati invece dalla porzione proof-of-stake dell'algoritmo.</p>
							<p>Il sistema Proof-of-stake inoltre evita la 'tassa' da ~$1 miliardo della rete Bitcoin di blocchi proof-of-work. <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'>Qui</a> puoi leggere di più al riguardo.</p>";
$locale_strings['ru']['faq_q_desc_efficiency'] = "
							<p>Генерация блоков proof-of-stake требует гораздо меньше энергии, чем интенсивное вычисление хэшей для proof-of-work. Это означает, что в дальнейшем сеть Peercoin будет потреблять значительно меньше энергии, поскольку уменьшится награда за блоки proof-of-work, и будут генерироваться в основном блоки proof-of-stake.</p>
				        		<p>Proof-of-stake также избавляет от проблемы чрезмерных расходов на обеспечение безопасности сети, от которой страдает Bitcoin из-за использования алгоритма proof-of-work. Подробнее об этой проблеме можно прочитать <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'>здесь</a>.</p>";
...
$locale_strings['pl']['faq_q_desc_efficiency'] = "
							<p>Generowanie bloków proof-of-stake wymaga znacznie mniej energii niż generowanie intensywnych sprzętowo obliczeń. A to oznacza, że z czasem sieć Peercoin bedzie pochłaniała mniej energii w miarę jak bloki w systemie proof-of-work staną się mniej opłacalne niz bloki generowane w części algorytmu proof-of-stake.</p>
							<p>Proof-of-stake jest również sposobem na ~$1 miliardowy 'podatek' na sieć Bitcoin poprzez bloki proof-of-work. Można o tym przeczytać więcej <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'>tutaj</a>.</p>";
...
$locale_strings['pl']['faq_q_title_myth1'] = "Mit #1 - Peercoin jest tylko klonem Bitcoin.";
...
$locale_strings['it']['faq_q_desc_myth1'] = "
						<p>Peercoin è una delle monete realmente uniche e non sono solamente un clone del codice originale Bitcoin.
						Peercoin è la prima moneta di introdurre una combinazione proof-of-stake/proof-of-work insieme ad altri meccanismi di efficienza energetica. Difatti, molte altcoin adesso integrano il proof-of-stake di Peercoin nel loro codice.
						<br/> <br/>
						Fonte: <a href='http://en.wikipedia.org/wiki/PPCoin#Distinguishing_features'>http://en.wikipedia.org/wiki/PPCoin#Distinguishing _features</a>
						</p>";
$locale_strings['ru']['faq_q_desc_myth1'] = "
						<p>Peercoin &ndash; это одна из наиболее уникальных криптовалют, не являющаяся просто клоном кода Bitcoin.
				           Peercoin &ndash; впервые представил миру комбинацию proof-of-stake и proof-of-work алгоритмов в сочетании другими механизмами, обеспечивающими энергетическую эффективность. На самом деле теперь многие альтернативные криптовалюты берут код Peercoin за основу для того, чтобы использовать proof-of-stake.
				           <br/> <br/>
						   Источник: <a href='http://en.wikipedia.org/wiki/PPCoin#Distinguishing_features'>http://en.wikipedia.org/wiki/PPCoin#Distinguishing_features</a>
						</p>";
...
$locale_strings['no']['faq_q_desc_myth1'] = "
...
$locale_strings['pl']['faq_q_desc_myth1'] = "
						<p>Peercoin jest jedną z unikalnych monet, które nie są zwykłymi klonami originalnego kodu Bitcoin.
						Peercoin jest pierwszą monetą, która wprowadziła kombinację proof-of-stake/proof-of-work oraz wiele innych energooszczędnych mechanizmów. Prawdę powiedziawszy, wiele innych monet strara się obecnie wprowadzać podobne rozwiązania do swego kodu.
						<br/> <br/>
						Źródło: <a href='http://en.wikipedia.org/wiki/PPCoin#Distinguishing_features'>http://en.wikipedia.org/wiki/PPCoin#Distinguishing_features</a>
						</p>";
...
$locale_strings['pl']['faq_q_title_myth2'] = "Mit #2 - Peercoin podlega centralizacji ze względu na zastosowanie punktów kontrolnych.";
...
$locale_strings['it']['faq_q_desc_myth2'] = "
						<p>I checkpoint sono una misura di protezione aggiuntiva e sono stati introdotti per proteggere la rete Peercoin da attacchi quando era appena nata. Chiarisce Sunny King:</p>
						<p>&quot;il rischio di attacco di tipo denial of service di 51% sulla catena di blocchi è reale, soprattutto ad una piccola rete. In realtà non sarebbe da escludere una tale possibilità anche a bitcoin. Naturalmente tale attacco su bitcoin probabilmente non verrebbe da un singolo a causa delle risorse richieste. Ma è irresponsabile dire che non è possibile. Provate a immaginare cosa accadrebbe se bitcoin arrestasse le transazioni per qualche giorno. &quot;</p>
						<p>Visto che la rete Peercoin è cresciuta sostanzialmente nell'ultimo anno, i checkpoint saranno eliminati in una delle prossime versioni, probabilmente in PPC 0.5.</p>";
$locale_strings['ru']['faq_q_desc_myth2'] = "
						<p>Контрольные точки &ndash; это дополнительная мера безопасности, призванная защитить сеть Peercoin от атак на раннем этапе развития. Sunny King объясняет:</p>
						<p>&quot;Риск 51% DoS-атаки на цепочку блоков реален, особенно для маленькой сети. На самом деле я бы не стал исключать такой возможности даже для Bitcoin. Конечно, такую атаку на Bitcoin вряд ли кто-то может произвести в одиночку, учитывая необходимые для этого ресурсы. Но будет безответственным заявлять, что это невозможно. Просто представьте, что будет, если сеть Bitcoin вдруг перестанет обслуживать транзакции на несколько дней.&quot;</p>
						<p>Поскольку за последний год сеть Peercoin существенно выросла, от использования контрольных точек скоро можно будет отказаться, возможно с релизом PPC 0.5.</p>";
...
$locale_strings['no']['faq_q_desc_myth2'] = "
...
$locale_strings['pl']['faq_q_desc_myth2'] = "
						<p>Punkty kontrolne są dodatkowym narzędziem bezpieczeństwa i zostały wprowadzone by zabezpieczać sieć Peercoin, gdy ta była w powijakach. Sunny King wyjaśnia:</p>
						<p>&quot;Ryzyko 51% ataku na block chain, typu denial-of-service, jest realne, zwłaszcza w przypadku mniejszych sieci. Szczerze powiedziawszy, nie wykluczałbym takiej możliwości nawet w przypadku Bitcoin. Oczywiście taki atak na Bitcoin nie mógłby nastąpić ze strony jednostki, ze względu na wymagane środki, ale byłoby nieodpowiedzialnym twierdzenie, że jest on niemożliwy. Wyoraźmy sobie co by się stało gdyby Bitcoin wstrzymało przetwarzanie transakcji na kilka dni.&quot;</p>
						<p>Dzięki wyraźnemu wzrostowi sieci Peercoin w ubiegłym roku, punkty kontrolne bedą wypierane w nowych wersjach, prawdopodobnie już w PPC 0.5.</p>";
...
$locale_strings['pl']['faq_q_title_myth3'] = "Mit #3 - Peercoin jest niezwykle podatna na inflację ze swej natury.";
...
$locale_strings['it']['faq_q_desc_myth3'] = "
						<p>No. Se Peercoin cresce rapidamente, il conio può temporaneamente diminuire poiché giorni di monete vengono persi durante gli scambi. Questo potrebbe far diventare Peercoin di tipo deflazionistico. La natura uniforme delle spese di transazione è destinata a contrastare questo diminuendo il volume totale delle transazioni. I fautori di Peercoin sostengono che questo diminuirà la deflazione.</p>
						<p>Inoltre, Bitcoin attualmente subisce <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'>un ~10%</a> di inflazione all'anno mentre si avvicina alla sua disponibilità totale di 21 milioni. Si <b>spera</b> che al raggiungimento della disponibilità totale le spese di transazione saranno sufficiente per sostenere una rete protetta.</p>
						<p>Per mantenere una rete protetta in futuro, Peercoin ha un 1% di inflazione all'anno (guadagno del proof-of-stake) per assicurarsi che ci sarà una rete protetta, non considerando le spese di transazione. Come dichiarato prima, questo può diventare deflazionistico, come Bitcoin mira ad essere, nel corso di elevati volumi di transazioni.</p>";
$locale_strings['en']['faq_q_desc_myth3'] = "
						<p>Нет. Если Peercoin будет резко расти, генерация proof-of-stake монет уменьшится, поскольку монето-дни будут теряться при торговле. Это заставит Peercoin стать дефляционным. Фиксированный размер комиссии на транзакции противостоит этому, снижая общий объём передаваемых монет. Сторонники Peercoin утверждают, что это снизит дефляцию.</p>
						<p>Более того, Bitcoin сейчас испытывает <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'>~10% инфляции</a> в год, пока приближается к своему лимиту в 21 миллион монет. <b>Надеются</b>, что когда они все будут выпущены, комиссий с транзакций будет достаточно для поддержания надёжной сети.</p>
						<p>Для поддержания надёжности сети в будущем в Peercoin заложена инфляция на 1% в год (награда за proof-of-stake), чтобы обеспечить интерес узлам сети и безопасную сеть независимо от комиссий за транзакции. Как упоминалось выше, в периоды высоких объёмов транзакций сеть может быть даже дефляционной.</p>";
...
$locale_strings['no']['faq_q_desc_myth3'] = "
...
$locale_strings['pl']['faq_q_desc_myth3'] = "
						<p>Nie. Jeśli Peercoin wzrośnie gwałtownie, stake minting może czasowo ulec zmniejszeniu ponieważ handel powoduje utratę mocy menniczej. To spowoduje efekt deflacji Peercoin. Płaska natura opłat transakcyjnych ma w zamierzeniu zapobieganie temu poprzez zmniejszenie wolumenu transakcji. Zwolennicy Peercoin argumentują, że zmniejszy to deflację.</p>
						<p>Co więcej, Bitcoin doświadcza obecnie <a href='http://letstalkbitcoin.com/is-bitcoin-overpaying-for-false-security/'> ~10%</a> rocznej inflacji w miarę zbliżania się do swej granicznej ilości 21 millionów. Istnieje <b>nadzieja</b>, że gdy całkowita ilośc monet zostanie osiągnięta, wówczas opłaty transakcyjne wystarczą do utrzymania bezpiecznej sieci.</p>
						<p>By w przyszłości móc utrzymać bezpieczną sieć, Peercoin ma 1% rocznej inflacji (proof-of-stake reward) zapewniającą bezpieczeństwo sieci niezależnie od opłat transakcyjnych. Jak wspomniano wcześniej, może to być przyczyną deflacji, jak w odniesieniu do Bitcoin, w przypadku wysokich wolumenów transakcji.</p>";
...
$locale_strings['pl']['convinced_you_header'] = "Czy już <b>Cię</b> przekonaliśmy?";
...
$locale_strings['pl']['convinced_you_desc'] = "Czas pobrać klienta i spróbować samemu. Jeśli masz jakieś pytania, zapytaj na <a href='http://www.peercointalk.org/'>forum</a>, lub z pośrednictwem linków społecznościowych poniżej.";
...
$locale_strings['pl']['tutorials'] = "Instrukcje";
...
$locale_strings['pl']['installing_wallet'] = "Instalowanie portfela";
...
$locale_strings['pl']['setting_up_wallet'] = "Ustawianie portfela";
...
$locale_strings['pl']['more_ellipsis'] = "Więcej...";
...
$locale_strings['pl']['second_ago'] = "sekundę temu";
...
$locale_strings['pl']['seconds_ago'] = "sekund temu";
