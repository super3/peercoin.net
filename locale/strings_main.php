...
$locale_strings['no']['faq_q_desc_innovation'] = "<p>Peercoin sin originale og bemerkelsesverdige oppfinnelse er proof-of-stake/proof-of-work hybridsystemet.</p>
...
$locale_strings['cat']['faq_q_desc_security'] = "<p>La generació de blocs mitjançant l'algoritme híbrid proof-of-work/proof-of-stake redueix el risc del defecte del Miner Egoísta de Cornell, atacs de\">50%\", i l'inflat de blocs que s'ha utilitzat per aprofitar-se d'altres monedes.</p>
...
$locale_strings['es']['faq_q_desc_security'] = "<p>La generación de bloques mediante el algoritmo híbrido proof-of-work/proof-of-stake reduce el riesgo del defecto del Minero Egoísta de Cornell, ataques de\">50%\", y el hinchado de bloques que se ha usado para aprovecharse de otras monedas.</p>
...
$locale_strings['gr']['faq_q_desc_security'] = "<p>Η παραγωγή blocks μέσω του υβριδικού αλγορίθμου απόδειξης-της-συμμετοχής μειώνει τον κίνδυνο του Ελλατώματος του Εγωιστή-Μεταλλωρύχου του Cornell, \">50%\" των επιθέσεων, και το block bloating που έχει χρησιμοποιηθεί για την εκμετάλλευση άλλων νομισμάτων.</p>
...
$locale_strings['it']['faq_q_desc_security'] = "<p>Generare blocchi attraverso l'algoritmo di prova-del-palo/prova-di-lavoro ibrida riduce il rischio del difetto di Cornell egoista-minatore, \">50%\" attacchi e il gonfiore del blocco che sono stati usati per sfruttare altre valute.</p>
...
$locale_strings['no']['faq_q_desc_security'] = "<p>Generering av blokker gjennom proof-of-work/proof-of-stake hybridalgoritmen reduserer risikoen for Selfish-Miner Cornell Flaw, \">50%\" angrep og oppblåsingen av blokker som har blitt brukt for å utnytte andre kryptovalutaer.</p>
