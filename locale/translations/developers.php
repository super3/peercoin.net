...
$lang['en'] += array(
	...
	'developers.cold_wallet_minting_desc' => 'Currently, in order to mint new coins, users must keep a wallet unlocked on the network, which is known as a <strong>hot wallet</strong>. Hot wallets are at a greater risk of malware stealing their coins, because the <strong>spending keys</strong> cannot be kept encrypted during the minting process. In the next version of Peercoin, special <strong>minting keys</strong> will allow users to mint while keeping their spending keys entirely offline.',
