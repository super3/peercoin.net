<?php include ('header.php'); ?>
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<h1><?php echo $Locale->getText("get_peercoins_mining"); ?></h1>
				<p><strong><?php echo $Locale->getText("get_peercoins_introduction"); ?></strong></p>
			</div>

			<div class="col-lg-6">
				<p>
					<?php echo $Locale->getText("get_peercoins_intro1"); ?>
				</p>
			</div>

			<div class="col-lg-6">
				<p>
					<?php echo $Locale->getText("get_peercoins_intro2"); ?>
				</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="item">
					<p>
						<strong><?php echo $Locale->getText("get_peercoins_set_up"); ?></strong><br />
						<?php echo $Locale->getText("get_peercoins_set_up_desc"); ?>
					</p>
				</div>

				<div class="item">
					<p>
						<strong><?php echo $Locale->getText("get_peercoins_sign_up"); ?></strong><br />
						<?php echo $Locale->getText("get_peercoins_sign_up_desc"); ?>
					</p>
				</div>
